...
export const PaymentForm = ({ 
  ...
  useEffect(() => {
    if (watchIsPaid) {
      // Criar data com horário definido para evitar problemas de fuso horário
      const today = new Date();
      today.setHours(15, 0, 0, 0); // 15:00 GMT-3 para evitar problemas de fuso horário
      
      // Define a data de pagamento como hoje apenas se não houver uma data já selecionada
      if (!form.getValues("paymentDate")) {
        form.setValue("paymentDate", formatDateToISO(today));
      }
