          ...
          {ownerSectionOpen && (
            <CardContent className="py-2 grid grid-cols-2 md:grid-cols-3 gap-2">
              {[
                ...
                { label: "RG", value: "{{owner.rg}}" },
                { label: "Nacionalidade", value: "{{owner.nationality}}" },
                { label: "Profissão", value: "{{owner.profession}}" },
          ...
          {contractSectionOpen && (
            <CardContent className="py-2 grid grid-cols-2 md:grid-cols-3 gap-2">
              {[
                ...
                { label: "ID do contrato original", value: "{{contract.originalContractId}}" },
                { label: "Data de início original", value: "{{contract.originalStartDate}}" },
                { label: "Data de término original", value: "{{contract.originalEndDate}}" },
                { label: "Período original", value: "{{contract.originalPeriod}}" },
